        ...
        <div className="mt-16">
          <div className="relative rounded-xl overflow-hidden">
            ...
            <div className="relative z-10 p-8 md:p-12 text-center">
              ...
              <a href="https://wa.me/5532999597839?text=Olá! Gostaria de fazer uma encomenda personalizada." target="_blank" rel="noopener noreferrer" className="btn-fiery inline-flex items-center gap-2"><MessageCircle className="w-5 h-5" />Falar no WhatsApp</a>
            </div>
          </div>
        </div>
